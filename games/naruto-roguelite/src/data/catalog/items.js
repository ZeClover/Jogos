...
// FERRAMENTA de uso único em combate via `ACTION_TYPES.ITEM` — sem
// Economia (Ryō/lojas/loot) ainda, então todo Personagem carrega um kit
// fixo (`characterBridge.js`), não comprado nem encontrado. Equipamento
// persistente (ARMA/CORPO/ACESSORIO recalculando atributos) fica para
// quando houver um sistema de loadout/equipar de verdade.
//
